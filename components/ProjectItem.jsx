...
export const ProjectItem = ({title, backgroundImg, projectUrl, buildWith}) => {
  return (
    <>
        <div className='bg-[#ecf0f3] dark:bg-slate-700 relative flex items-center justify-center h-full w-full border-solid border-2 lg:border-4 shadow-xl shadow-[#a65fec] rounded-xl p-4 group hover:bg-[#a65fec] dark:hover:bg-[#a65fec]'>
