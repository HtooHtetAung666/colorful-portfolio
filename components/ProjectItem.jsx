...
export const ProjectItem = ({title, backgroundImg, projectUrl, buildWith}) => {
  return (
    <>
        <div className='relative flex items-center justify-center h-full w-full shadow-xl shadow-gray-600 dark:shadow-gray-900 rounded-xl p-4 group hover:bg-gray-300'>
