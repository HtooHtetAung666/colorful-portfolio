...
export const ProjectItem = ({title, backgroundImg, projectUrl, buildWith}) => {
  return (
    <>
        <div className='bg-[#ecf0f3] dark:bg-slate-900 relative flex items-center justify-center h-full w-full border-solid border-2 lg:border-4 border-indigo-400 shadow-xl shadow-[#f48037] dark:shadow-[#483d8b] rounded-xl p-4 group hover:bg-[#f48037] dark:hover:bg-[#483d8b]'>
