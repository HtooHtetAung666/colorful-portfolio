...
export const Skills = () => {
  return (
    <div className='w-full h-full my-16 p-4 md:my-32 md:pt-32 lg:h-screen '>
        <div className='mx-auto flex flex-col justify-center'>

            <h1 className='text-center tracking-widest text-[#a65fec] text-xl uppercase md:text-2xl lg:text-3xl'>Skills</h1>
