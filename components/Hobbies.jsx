...
const Hobbies = () => {
  return (
    <div id='hobbies' className='relative w-full h-full my-16 p-4 md:my-32 md:pt-32 lg:min-h-screen'>
        ...
        <h1 className='text-center tracking-widest text-indigo-400 dark:text-orange-300 text-xl uppercase md:text-2xl lg:text-3xl'>Hobbies</h1>
        ...
        <div className='my-16 grid gap-12 md:mx-24 md:mt-32 md:grid-cols-3 lg:mx-64'>
            ...
            <svg
            className='absolute top-0 right-0 w-44 h-28 mt-52 md:mt-16 md:w-60 md:h-32 lg:w-80 lg:h-44 lg:mr-20' 
            viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg
        className='absolute left-0 w-40 h-24 -mt-12 md:w-60 md:h-32 md:-mt-0 md:ml-48 lg:w-80 lg:h-44 lg:ml-96' 
        viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
