...
export const Footer = () => {
  return (
    <div className="mt-16 rounded-tl-3xl lg:rounded-tl-full bg-gradient-to-r from-purple-dark dark:from-gray-700 to-purple-light dark:to-gray-600 items-center justify-center py-2 lg:space-y-4">
