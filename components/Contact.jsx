...
export const Contact = () => {
  return (
    <div className='w-full flex items-center justify-center my-20 px-16 md:min-h-screen'>
      <div className='relative w-full max-w-lg'>
        ...
        <div className='absolute -bottom-8 left-28 w-44 h-44 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-80 animate-blob animation-delay-4000 md:w-72 md:h-72 lg:w-80 lg:h-80'></div>
