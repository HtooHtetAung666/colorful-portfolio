    ...
    return (
        <div className='relative'>
            <div id='hobbies' className='w-full h-full my-28 p-4 md:my-32 md:pt-28 lg:min-h-screen'>
                ...
                <svg 
                className='absolute top-0 left-0 w-40 h-24 -mt-12 md:w-28 md:h-28 md:-mt-0 lg:w-40 lg:h-40 lg:ml-16'
                ...
                <div className='my-16 grid gap-12 md:mx-24 md:mt-24 md:grid-cols-3 lg:mt-32 lg:mx-30 xl:mx-60'>
                    ...
                    <svg
                    className='absolute top-0 right-0 w-44 h-28 mt-52 md:mt-16 md:w-28 md:h-28 lg:w-40 lg:h-40 lg:mr-8' 
                    viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg
                className='absolute left-0 w-40 h-24 -mt-12 md:w-28 md:h-28 md:-mt-0 md:ml-48 lg:w-40 lg:h-40 lg:ml-96 lg:mt-16' 
                viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
