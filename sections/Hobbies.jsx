    ...
    return (
        <div className='relative'>
            <div id='hobbies' className='w-full h-full my-28 p-4 md:my-32 md:pt-28 lg:min-h-screen'>
                ...
                viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#6488EA" d="M40.3,-50.2C55.6,-44.4,73.6,-37.1,73.3,-26.5C73,-15.9,54.4,-2.2,47.1,13.8C39.9,29.8,43.9,47.9,38,59.1C32,70.3,16,74.5,-0.8,75.6C-17.7,76.7,-35.3,74.8,-47,65.5C-58.8,56.2,-64.6,39.6,-63.9,24.8C-63.2,10,-56.1,-3,-53.7,-19.7C-51.4,-36.5,-53.9,-57.1,-45.8,-65.2C-37.6,-73.2,-18.8,-68.8,-3.1,-64.5C12.5,-60.2,25.1,-56,40.3,-50.2Z" transform="translate(100 100)" />
                </svg>
