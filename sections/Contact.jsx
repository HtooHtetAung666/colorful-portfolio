  ...
  return (
    <div id='contact' className='w-full flex items-center justify-center my-40 px-16 md:my-12 md:min-h-screen'>
      <div className='relative w-full max-w-lg'>
        ...
        <div className='absolute -bottom-8 left-28 w-40 h-40 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-80 dark:blur-none dark:opacity-100 animate-blob animation-delay-4000 md:w-72 md:h-72 lg:w-80 lg:h-80'></div>
