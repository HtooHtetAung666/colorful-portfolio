...
export const HeroSection = () => {
  return (
    <>
          ...
          <div className='px-0 pt-16 pb-8 items-center space-y-10 md:space-y-0 md:flex md:px-10 md:pt-20 md:pb-10 md:justify-between lg:px-32 lg:py-36 xl:px-60'>
              <div className='space-y-8 xl:space-y-10'>
                <div className='flex items-center justify-center lg:justify-start'>
                  <h1 className='text-[#060606] font-bold text-xl mx-2 md:text-2xl lg:text-4xl'>
                    Hi 
                  </h1>
      ...
      <div className='w-full h-4 bg-gradient-to-r from-[#84329b] via-[#a65fec] to-[#8b60ed] hidden lg:block'></div>
