          ...
          return (
              <div key={idx}>
                <div className='flex flex-col md:flex-row md:space-x-12 lg:px-16'>
                      ...
                      >
                        <h1 className='text-lg md:text-xl lg:text-2xl 3xl:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#84329b] to-[#a65fec] dark:brightness-125'>{project.name}</h1>
                        <p className='mt-3 mb-3 md:mt-4 md:mb-4 lg:mt-6 text-sm md:text-md lg:text-lg leading-7 lg:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#84329b] to-[#a65fec] dark:brightness-125'>{project.description}</p>
